...
$messages['fa'] = array(
	...
	'newestpages-ns-header' => "'''این صفحه،{{PLURAL:$1|جدیدترین صفحه|$1 جدیدترین صفحات}} را در فضای نام $2 فهرست می‌کند.'''",
...
$messages['is'] = array(
	...
	'newestpages-header' => "'''Þessi síða listar $1 {{PLURAL:$1|nýjustu síðuna|nýjustu síðurnar}} á þessu wiki.'''",
	'newestpages-limitlinks' => 'Sýna að hámarki $1 síður',
	'newestpages-namespace' => 'Nafnrými:',
	'newestpages-none' => 'Engin færsla fannst.',
	'newestpages-ns-header' => "'''Þessi síða listar $1 {{PLURAL:$1|nýjustu síðuna|nýjustu síðurnar}} í $2 nafnarýminu.'''",
	'newestpages-showing' => 'Lista $1 {{PLURAL:$1|nýjustu síðuna|nýjustu síðurnar}}:',
...
$messages['lb'] = array(
	...
	'newestpages-header' => "'''Op dëser Säit {{PLURAL:$1|steet déi neiste Säit|stinn déi $1 neiste Säite}} vun der Wiki.'''",
...
$messages['vep'] = array(
	...
	'newestpages-desc' => "Ozutab [[Special:NewestPages|jäl'gmäižed X lehtpol't]], kudambad om ližatud wikihe.",
	'newestpages-header' => "'''Nece lehtpol' ozutab wikin {{PLURAL:$1|jäl'gmäine lehtpol'|$1 jäl'gmäšt lehtpol't}}.'''",
	'newestpages-limitlinks' => "Ozutada $1-ha lehtpol'hesai",
	'newestpages-namespace' => 'Nimiavaruz:',
	'newestpages-none' => 'Ei löudand kirjutesid.',
